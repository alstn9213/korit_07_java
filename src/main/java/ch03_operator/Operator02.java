...
/*
    ...
    NOR(!): true 값을 false로, false값을 true로 역전시키는 연산자
 */
public class Operator02 {
    public static void main(String[] args) {
        ...
        System.out.println("T + F = " + result4); // true
        boolean result5 = flag1 || flag1;
        System.out.println("T + T = " + result5); // true
        boolean result6 = flag2 || flag2;
        System.out.println("F + F = "+ result6); // false

        boolean result7 = (flag1 || flag2) && flag2; // false

        boolean result8 = 10 % 3 == 0;
//        나머지 연산의 결과값의 자료형은 무엇이어야만 하는가? -> int
